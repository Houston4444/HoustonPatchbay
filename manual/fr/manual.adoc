...
* *Sélection automatique des objets*: Sélectionne les boîtes, les ports et les portgroups au survol de la souris. Peut permettre d'identifier plus vite certaines connections.
...
* *Largeur maximale des ports*: Certains programmes écrivent des noms de ports trèèèèès longs, ces noms seront donc tronqués au delà du nombre de points défini pour éviter une largeur de boîte trop importante.
