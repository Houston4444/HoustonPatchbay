...
The following settings are available only for *box* and childs blocks.
...
* *port-in-offset*: <<number>>, offset the input ports X coordinate
* *port-out-offset*: <<number>>, offset the output ports X coordinate
* *port-offset*: <<number>>, offset the ports X coordinate
...
* *port-spacing* : <<number>>, height of spacing between ports
* *port-type-spacing*: <<number>>, height of spacing between ports of different types
